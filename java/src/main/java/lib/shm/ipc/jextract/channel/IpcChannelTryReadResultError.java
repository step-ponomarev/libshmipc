...
/**
 * {@snippet lang=c :
 * struct IpcChannelTryReadResultError {
 *     const char *detail;
 *     IpcChannelTryReadError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelTryReadResultError {

    IpcChannelTryReadResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelTryReadError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelTryReadResultError");
