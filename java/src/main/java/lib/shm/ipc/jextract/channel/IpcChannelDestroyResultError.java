...
/**
 * {@snippet lang=c :
 * struct IpcChannelDestroyResultError {
 *     const char *detail;
 *     IpcChannelDestroyError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelDestroyResultError {

    IpcChannelDestroyResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelDestroyError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(6)
    ).withName("IpcChannelDestroyResultError");
