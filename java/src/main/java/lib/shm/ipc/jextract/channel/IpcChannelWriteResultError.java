...
/**
 * {@snippet lang=c :
 * struct IpcChannelWriteResultError {
 *     const char *detail;
 *     IpcChannelWriteError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelWriteResultError {

    IpcChannelWriteResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelWriteError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelWriteResultError");
