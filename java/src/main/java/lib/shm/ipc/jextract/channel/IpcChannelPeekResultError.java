...
/**
 * {@snippet lang=c :
 * struct IpcChannelPeekResultError {
 *     const char *detail;
 *     IpcChannelPeekError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelPeekResultError {

    IpcChannelPeekResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelPeekError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelPeekResultError");
