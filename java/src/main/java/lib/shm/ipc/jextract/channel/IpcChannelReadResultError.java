...
/**
 * {@snippet lang=c :
 * struct IpcChannelReadResultError {
 *     const char *detail;
 *     IpcChannelReadError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelReadResultError {

    IpcChannelReadResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelReadError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelReadResultError");
