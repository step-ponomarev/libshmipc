...
/**
 * {@snippet lang=c :
 * struct IpcChannelConnectResultError {
 *     const char *detail;
 ...
 * }
 */
public class IpcChannelConnectResultError {

    IpcChannelConnectResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelConnectError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelConnectResultError");
