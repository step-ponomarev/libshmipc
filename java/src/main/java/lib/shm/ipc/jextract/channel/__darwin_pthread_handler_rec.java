...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("__routine"),
        ipc_channel_h.C_POINTER.withName("__arg"),
        ipc_channel_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = ipc_channel_h.upcallHandle(__routine.Function.class, "apply", $DESC);
