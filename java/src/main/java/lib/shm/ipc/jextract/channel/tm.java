...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_INT.withName("tm_sec"),
        ipc_channel_h.C_INT.withName("tm_min"),
        ipc_channel_h.C_INT.withName("tm_hour"),
        ipc_channel_h.C_INT.withName("tm_mday"),
        ipc_channel_h.C_INT.withName("tm_mon"),
        ipc_channel_h.C_INT.withName("tm_year"),
        ipc_channel_h.C_INT.withName("tm_wday"),
        ipc_channel_h.C_INT.withName("tm_yday"),
        ipc_channel_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        ipc_channel_h.C_LONG.withName("tm_gmtoff"),
        ipc_channel_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
