...
/**
 * {@snippet lang=c :
 * struct IpcChannelSkipResultError {
 *     const char *detail;
 *     IpcChannelSkipError body;
 *     bool hasBody;
 * }
 * }
 */
public class IpcChannelSkipResultError {

    IpcChannelSkipResultError() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ipc_channel_h.C_POINTER.withName("detail"),
        IpcChannelSkipError.layout().withName("body"),
        ipc_channel_h.C_BOOL.withName("hasBody"),
        MemoryLayout.paddingLayout(7)
    ).withName("IpcChannelSkipResultError");
