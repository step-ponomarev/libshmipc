...
static IpcChannelReadResult _try_read(ipc_channel_t *, ipc_entry_t *);
...
IpcChannelReadResult ipc_channel_read(ipc_channel_t *channel, ipc_entry_t *dest, const struct timespec *timeout) {
...
static IpcChannelReadResult _try_read(ipc_channel_t *channel, ipc_entry_t *dest) {
    IpcChannelReadError error = {.offset = 0, .timeout_used = {0, 0}};
