...
SHMIPC_API void ipc_buffer_destroy(ipc_buffer_t *buffer);
...
SHMIPC_API ipc_status_t ipc_buffer_next_size(ipc_buffer_t *buffer, size_t *out_size, ipc_error_t *err);
